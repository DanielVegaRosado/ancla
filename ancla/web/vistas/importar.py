...
from ancla.perfil import almacen, importador, validacion
...
from ancla.web.util import lineas_a_lista
...
def importar():
    ...
    return redirect(url_for("ancla.revisar_importacion"))
...
def revisar_importacion():
    ...
    if importacion is None:
        ...
        return redirect(url_for("ancla.importar"))
